...
#   VERSION: 0.1.3
#   SCREENSHOT: https://github.com/max-devjs/max0003
# ------------------------------------------------------------------------------
...
PROMPT='$(git_prompt_short_sha)$(git_prompt_info)$(git_time_since_commit)$(git_prompt_status)%{$reset_color%}
$(prompt_char)'
